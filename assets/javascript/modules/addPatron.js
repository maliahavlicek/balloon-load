...
function addPatron() {
    ...
    let new_element = `<div class="group guest group-${group_no} d-flex flex-column" draggable="true" data-group_number="${group_no}"style="--translateX:0; --translateY:0;" draggable="true" >` +
        ...
        `<div class="person group group-${group_no} d-flex flex-row" data-weight="${weight}" data-count="1" data-group_number="${group_no}" data-name="${name}" style="--translateX:0;--translateY:0;">` +
